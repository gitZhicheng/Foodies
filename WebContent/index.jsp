	  ...
	  <div class="navbar-inner">
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  <li class="navbar-brand"><a style="font-size:17px;color:#0269c2" href="index.html">Foodies	</a></li>
			...
			<li class="dropdown">
				...
				<form class="form-horizontal loginFrm">
				  <div class="control-group">
				    <div class="alert alert-error" id="failmsg">
				      <span>Please try again.</span>
				    </div>
				  </div>
				  <div class="control-group">
					<input type="text" class="span3" id="username" placeholder="Username">
				  </div>
				  <div class="control-group">
				  ...
				  <div class="control-group">
					...
					<button id="login" type="button" class="shopBtn btn-block" onclick="loginFailed()">Sign in</button>
				  </div>
				  <div class="control-group message">
				  	<span>Not registered? <a href="#">Create an account</a></span>
				  </div>
				</form>
				</div>
			</li>
...
<div class="well well-small">
	<ul class="nav nav-list">
		...
		<li style="padding-left:50px;padding-right:50px"><a href="allcategories.html"><strong>All Categories</strong></a></li>
	</ul>
</div>
	</div>
	...
	<div class="well np">
		<div id="myCarousel" class="carousel slide homCar">
            <div class="carousel-inner">
			  <div class="item">
                <img style="max-height:330px" src="http://images.media-allrecipes.com/images/52562.jpg" alt="bootstrap ecommerce templates">
              </div>
			  <div class="item active">
                <img style="max-height:330px" src="http://images.media-allrecipes.com/userphotos/560x315/1107530.jpg"
                 alt="bootstrap ecommerce templates">
              </div>
              <div class="item">
                <img style="max-height:330px" src="http://images.media-allrecipes.com/images/56079.jpg" 
...
-->
			...
			<li class="span4">
			  <div class="thumbnail">
				...
				<div class="caption cntr">
					<p><a>Recipe Name</a></p>
					<p><a href="#">Recipe by UserName</a></p>
				</div>
			  </div>
			</li>
			<li class="span4">
	...
	-->
		<div class="well well-small">
		  <h3><a class="btn btn-mini pull-right" href="products.html" title="View more">VIew More<span class="icon-plus"></span></a>Popular Recipes </h3>
		  <hr class="soften"/>
		  <div class="row-fluid">
		  <ul class="thumbnails">
			<li class="span4">
